                ...
                <div className="w-full">
                    {messages.length === 0 && <div className="mb-4">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            })} className='px-2 py-1 bg-gray-800 text-gray-200 rounded-md text-xs cursor-pointer'>When is my next flight?</span>
                            <span onClick={() => handleInputChange({
                                target: {
                                    value: 'When is my next meeting?'
                                }
                            })} className='px-2 py-1 bg-gray-800 text-gray-200 rounded-md text-xs cursor-pointer'>When is my next meeting?</span>
                        </div>
                    </div>
                    }
